    ...
    <section class="bg-dark text-white">
      ...
      <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ec027f4a7a75f9cd6ba56c97e88f31ae&libraries=services,clusterer,drawing"></script>
        ...
        <script>
		   ...
		   geocoder.addressSearch('강원 원주시 웅비1길 5', function(result, status) {
			    ...
			    // 정상적으로 검색이 완료됐으면 
			     if (status === daum.maps.services.Status.OK) {
			        ...
			        var infowindow = new daum.maps.InfoWindow({
			            content: '<div style="width:150px;text-align:center;padding:6px 0; color:black;">낭만섬</div>'
			        });
